...
alias ccd='colcon_cd'
alias cbc='colcon build --symlink-install --cmake-args -DCMAKE_BUILD_TYPE=Debug'
alias cbcf='colcon build --symlink-install --cmake-args -DCMAKE_BUILD_TYPE=Debug --packages-select'
...
export _colcon_de_root=~/robot_ws/install
